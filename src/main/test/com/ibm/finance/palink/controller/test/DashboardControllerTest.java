...
private MockMvc mockMvc;
	...
	public void testGetDashboardData() throws Exception {
		...
		/*responseDto.getResponseHeader().setQuoteID("12345");
		responseDto.getResponseHeader().setQuoteType("SW");*/
		...
		/*
		 * Object o = mockMvc.perform(get("/getDashboardData/getSWQuoteData/12345"))				        		
                .andExpect(status().isOk());  
		
		 */
		Object o = mockMvc.perform(get("/getDashboardData/12345/SW")).andExpect(status().isOk());
	}
}
